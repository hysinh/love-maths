...
function runGame(gameType) {
    ...
    document.getElementById("answer-box").value = ""; // empties answer box each time game loads
    document.getElementById("answer-box").focus(); // setting the focus
...
/**
 * Gets the currect incorrect score from the DOM and increments it by 1
 */
